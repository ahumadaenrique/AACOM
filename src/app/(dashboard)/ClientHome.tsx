...
export default function ClientHome({ announcements, isBirthday = false, currentUser = null, agencyName = "AACOM Seguros", isAdmin = false }: ClientHomeProps) {
  ...
  return (
      <div className="space-y-6 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="col-span-1 md:col-span-3 lg:col-span-3 overflow-hidden border-0 shadow-lg relative h-64 bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center hover:scale-[1.01] hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10 text-center p-6">
              <h2 className="text-4xl font-extrabold mb-2 tracking-tight">CAMPAÑAS</h2>
              <p className="text-lg font-medium opacity-90">Aquí puedes ver las campañas vigentes de tus aseguradoras y promotoría</p>
            </div>
          </Card>
